...
use crate::common::generate_single_reth_input;
...
async fn fetch_and_generate_input(
    ...
    // Get transaction count and gas used from the block for naming
    ...
    // Generate reth input using shared function
    generate_single_reth_input(&fixture, output, format)
}
