...
// Panic handler for all guest targets.
#[cfg(zisk_guest)]
#[panic_handler]
...
// Bump allocator backed by linker-script heap symbols — used on all guest targets.
#[cfg(zisk_guest)]
mod bump_alloc;
...
pub fn main() {
    ...
    // Initialize the bump allocator from linker-script heap bounds.
    #[cfg(zisk_guest)]
